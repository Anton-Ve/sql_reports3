...
declare
   ...
   l_SQL_DATA   clob := Q'#
   select 
    cast (null as CHAR (10)) SP_ID
,   cast (null as CHAR (10)) MTR_CONFIG_ID 
,   cast (null as CHAR (10)) MTR_ID 
,   cast (null as VARCHAR2 (16)) SERIAL_NBR  
,   cast (null as CHAR(8)) MFG_CD
,   cast (null as CHAR(8)) MODEL_CD
,   cast (null as CHAR(8)) MTR_TYPE_CD
,   cast (null as DATE) INSTALL_DT
,   cast (null as NUMBER(15,6)) REG_READING1
,   cast (null as NUMBER(15,6)) REG_READING2
,   cast (null as NUMBER(15,6)) REG_READING3 
,   cast (null as VARCHAR2(254)) DPP
,   cast (null as CHAR(16)) PPV
,   cast (null as NUMBER(12,6))INSTALL_CONST  
,   cast (null as char(10)) isu 
from dual 
where 1=0
   #';
   l_index number;
